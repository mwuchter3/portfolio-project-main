...
The design I am going to go with for now is the Martix component. I think this component will be better than a music playlist or a 2D table because it has more properties than a simple 2D table, and a music playlist seems quite boring. A matrix could be tranposed, inverted, row operations, and so much more. With all of these options I feel like a matrix will be beteter to create.
